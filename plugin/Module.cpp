...
// GNNSched
PyObject * THCPModule_insertSharedCacheForComputation(PyObject *_unused, PyObject *args)
{
  HANDLE_TH_ERRORS
      PyObject* size_o = nullptr;
      PyObject* offset_o = nullptr;

      if(!PyArg_ParseTuple(args, "OO", &size_o, &offset_o)) {
        THPUtils_invalidArguments(
            args,
            nullptr,
            "insert_shared_cache_for_computation",
            1,
            "(size_t size, size_t offset);");
        return nullptr;
      }
      size_t size = PyLong_AsSize_t(size_o);
      size_t offset = PyLong_AsSize_t(offset_o);

      c10::cuda::CUDACachingAllocator::insertSharedCache(size, offset);
  END_HANDLE_TH_ERRORS
  Py_RETURN_NONE;
}
...
static struct PyMethodDef _THCPModule_methods[] = {
  ...
  {"_cuda_allocateSharedCache", THCPModule_allocateSharedCache, METH_NOARGS, nullptr}, // GNNSched
  {"_cuda_sendSharedCache", THCPModule_sendSharedCache, METH_NOARGS, nullptr}, // GNNSched
  {"_cuda_recvSharedCache", THCPModule_recvSharedCache, METH_NOARGS, nullptr}, // GNNSched
  {"_cuda_insertSharedCacheForComputation", THCPModule_insertSharedCacheForComputation, METH_VARARGS, nullptr}, // GNNSched
  {"_cuda_clearSharedCache", THCPModule_clearSharedCache, METH_NOARGS, nullptr}, // GNNSched
