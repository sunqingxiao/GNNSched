...
C10_CUDA_API void allocateSharedCache(); // GNNSched
C10_CUDA_API void sendSharedCache(); // GNNSched
C10_CUDA_API void recvSharedCache(); // GNNSched
C10_CUDA_API void insertSharedCache(size_t size, size_t offset); // GNNSched
C10_CUDA_API void clearSharedCache(); // GNNSched
